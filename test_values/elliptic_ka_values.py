#!/usr/bin/env python
#
def elliptic_ka_values ( n_data ):

#*****************************************************************************80
#
## ELLIPTIC_KA_VALUES ELLIPTIC_KA_VALUES returns values of the complete elliptic integral K(ALPHA).
#
#  Discussion:
#
...
#
  print ''
  print 'ELLIPTIC_KA_VALUES_TEST:'
  print '  ELLIPTIC_KA_VALUES stores values of the complete elliptic'
  print '  integral of the first kind, with parameter ALPHA in degrees.'
  print ''
  print '      ALPHA         EA(ALPHA)'
  print ''
